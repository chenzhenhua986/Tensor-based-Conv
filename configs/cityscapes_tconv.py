...
from net import tconv_backbone_tconv_head, official_deeplab_resnet, pretrained_backbone_tconv_head, tconv_backbone_conv_head, tconv, tconv1, tconv_fcn, tconv_fcn1, tconv_lraspp
...
num_classes = 21
#model = deeplabv3_resnet101(weights=DeepLabV3_ResNet101_Weights.DEFAULT, num_classes=num_classes, weights_backbone=None)
...
#model = tconv(device, num_classes)
#model = tconv_fcn(device, num_classes)
#model = tconv1(device, num_classes)
#model = tconv_lraspp(device, num_classes)
